...
void print_hollow_diamond_bottom(int num);

void print_hollow_diamond_top(int num);
...
int main() {
  ...
  while(num<0){
    cin>>num; // check for positive number of rows
  }

    print_hollow_diamond_top(num);
    print_hollow_diamond_bottom(num);
